...
function initRoutingModule() {
    ...
    if (typeof L !== 'undefined' && L.Routing) {
        try {
            ...
            console.warn('[ROUTING] Erreur lors de l\'initialisation du routing:', error);
            console.log('[ROUTING] Module de routage désactivé pour éviter les erreurs');
        }
    } else {
        console.log('[ROUTING] Leaflet Routing Machine non disponible - module désactivé');
    }
}
